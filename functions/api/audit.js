...
const ACTIONS = new Set(["job.delete", "equipment.delete", "employee.delete", "company.delete", "invoice.delete", "report.delete", "request.delete", "kpi.deduct", "kpi.undo", "receive", "approve", "reject", "equipment.lost_remove", "equipment.lost_found", "line.unlink"]);
